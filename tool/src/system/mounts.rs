...
impl Context {
    ...
    pub fn is_mounted(&self, mount_path: &str) -> Result<bool, Error> {
        self.exec_ok(Process::new("findmnt", &["--mountpoint", mount_path]))
    }

    pub fn mount_readonly(&self, device_path: &str, mount_path: &str) -> Result<(), Error> {
    ...
    pub fn unmount(&self, mount_path: &str) -> Result<(), Error> {
